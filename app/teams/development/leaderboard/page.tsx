...
import { Search, RefreshCw, Download, Trophy, Medal, Award, GitPullRequest, Github, CheckCircle } from 'lucide-react';
...
export default function DevelopmentLeaderboardPage() {
  ...
  const fetchLeaderboard = async () => {
    setLoading(true);
    try {
      const response = await fetch('/api/leaderboard/development');
  ...
  const handleExport = () => {
    const csv = [
      ['Rank', 'Name', 'GitHub', 'Merged PRs', 'Lines (+/-)', 'Points', 'Year'].join(','),
      ...filteredEntries.map((entry) =>
        [
          ...
          entry.username,
          entry.mergedPRs,
          `${entry.totalAdditions}/${entry.totalDeletions}`,
          entry.points,
          entry.year || '',
        ].join(',')
      ),
    ...
    a.href = url;
    a.download = `sangaam-leaderboard-${new Date().toISOString().split('T')[0]}.csv`;
    a.click();
  };
    ...
    <div className="min-h-screen py-12">
      <div className="container-custom">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold gradient-text mb-4">SANGAAM 2026</h1>
          <p className="text-xl text-gray-300">Open Source Contribution Leaderboard</p>
        </div>
        ...
        <div className="card-glass p-6 mb-8">
          ...
          <div className="text-sm text-gray-400 text-center">
            ...
            <span className="text-secondary">{filteredEntries.length} contributors</span>
          </div>
        </div>
                ...
                <table className="w-full">
                  <thead className="bg-white/5 border-b border-white/10">
                    <tr>
                      ...
                      <th className="px-6 py-4 text-center text-sm font-semibold">Merged PRs</th>
                      <th className="px-6 py-4 text-center text-sm font-semibold">Lines (+/-)</th>
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <a
                            ...
                            className="text-[#00acc1] hover:text-[#00bcd4] flex items-center space-x-1"
                        ...
                        <td className="px-6 py-4 text-center">
                          <div className="flex items-center justify-center space-x-1">
                            ...
                            <span className="font-semibold text-green-400">{entry.mergedPRs}</span>
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-4 text-center font-bold text-[#00acc1]">
                          {entry.points}
                        </td>
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-8">
          <div className="card-glass p-6">
            <h3 className="text-xl font-bold mb-4">Scoring System</h3>
            <ul className="space-y-2 text-gray-300 text-sm">
              <li>• Each merged PR = 10 points</li>
              <li>• Lines added = +1 point per 100 lines</li>
              <li>• Quality bonus up to 5 points</li>
              <li>• Rankings update every 15 minutes</li>
            </ul>
          </div>
